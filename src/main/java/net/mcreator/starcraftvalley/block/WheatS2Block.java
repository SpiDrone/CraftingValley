...
public class WheatS2Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:wheat_s_2")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:wheat_s_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public WheatS2Block(StarcraftvalleyModElements instance) {
		super(instance, 140);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("wheat_s_2"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(1, 0, 1, 15, 4, 15)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("wheat_s_2");
		}
