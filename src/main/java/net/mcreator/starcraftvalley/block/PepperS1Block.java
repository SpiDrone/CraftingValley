...
public class PepperS1Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:pepper_s_1")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:pepper_s_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public PepperS1Block(StarcraftvalleyModElements instance) {
		super(instance, 24);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("pepper_s_1"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("pepper_s_1");
		}
