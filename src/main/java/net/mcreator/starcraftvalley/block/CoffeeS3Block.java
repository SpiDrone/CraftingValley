...
public class CoffeeS3Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:coffee_s_3")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:coffee_s_3")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public CoffeeS3Block(StarcraftvalleyModElements instance) {
		super(instance, 67);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("coffee_s_3"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(1, 0, 1, 15, 11, 15)
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(CoffeeBeanItem.block);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("coffee_s_3");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Coffee Tree");
		}
