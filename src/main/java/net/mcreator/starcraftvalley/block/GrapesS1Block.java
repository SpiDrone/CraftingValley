...
public class GrapesS1Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:grapes_s_1")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:grapes_s_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public GrapesS1Block(StarcraftvalleyModElements instance) {
		super(instance, 27);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("grapes_s_1"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).hardnessAndResistance(0f, 0f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.AXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("grapes_s_1");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("grapes_s_1");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("(Trellis) Grapes");
		}
