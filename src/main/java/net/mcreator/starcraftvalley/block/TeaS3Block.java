...
public class TeaS3Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:tea_s_3")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:tea_s_3")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public TeaS3Block(StarcraftvalleyModElements instance) {
		super(instance, 57);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("tea_s_3"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("tea_s_3");
		}
