...
public class WheatS3Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:wheat_s_3")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:wheat_s_3")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public WheatS3Block(StarcraftvalleyModElements instance) {
		super(instance, 141);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("wheat_s_3"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("wheat_s_3");
		}
