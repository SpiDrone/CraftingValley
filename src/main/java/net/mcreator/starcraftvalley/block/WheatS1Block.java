...
public class WheatS1Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:wheat_s_1")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:wheat_s_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public WheatS1Block(StarcraftvalleyModElements instance) {
		super(instance, 136);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("wheat_s_1"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(WheatSeedsItem.block);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("wheat_s_1");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Wheat");
		}
