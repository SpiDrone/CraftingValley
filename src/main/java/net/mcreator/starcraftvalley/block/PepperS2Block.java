...
public class PepperS2Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:pepper_s_2")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:pepper_s_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public PepperS2Block(StarcraftvalleyModElements instance) {
		super(instance, 25);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("pepper_s_2"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("pepper_s_2");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Pepper");
		}
