...
public class CauliflowerS3Block extends SproutModElements.ModElement {
	@ObjectHolder("sprout:cauliflower_s_3")
	public static final Block block = null;

	public CauliflowerS3Block(SproutModElements instance) {
		super(instance, 20);
	}
