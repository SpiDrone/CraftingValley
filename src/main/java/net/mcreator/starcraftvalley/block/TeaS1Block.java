...
public class TeaS1Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:tea_s_1")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:tea_s_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public TeaS1Block(StarcraftvalleyModElements instance) {
		super(instance, 55);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("tea_s_1"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("tea_s_1");
		}
