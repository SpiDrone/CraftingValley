...
public class StrawberryS1Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:strawberry_s_1")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:strawberry_s_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public StrawberryS1Block(StarcraftvalleyModElements instance) {
		super(instance, 10);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("strawberry_s_1"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("strawberry_s_1");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("strawberry_s_1");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Strawberry Bush");
		}
