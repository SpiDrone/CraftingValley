...
public class CoffeeS2Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:coffee_s_2")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:coffee_s_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public CoffeeS2Block(StarcraftvalleyModElements instance) {
		super(instance, 66);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("coffee_s_2"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(2, 0, 2, 14, 3, 14)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("coffee_s_2");
		}
