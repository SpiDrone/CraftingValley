...
public class CauliflowerS1Block extends SproutModElements.ModElement {
	@ObjectHolder("sprout:cauliflower_s_1")
	public static final Block block = null;

	public CauliflowerS1Block(SproutModElements instance) {
		super(instance, 18);
	}
