...
public class CabbageRedS2Block extends SproutModElements.ModElement {
	@ObjectHolder("sprout:cabbage_red_s_2")
	public static final Block block = null;
	@ObjectHolder("sprout:cabbage_red_s_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public CabbageRedS2Block(SproutModElements instance) {
		super(instance, 129);
