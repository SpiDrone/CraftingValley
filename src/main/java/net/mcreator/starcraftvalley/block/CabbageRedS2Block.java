...
public class CabbageRedS2Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:cabbage_red_s_2")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:cabbage_red_s_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public CabbageRedS2Block(StarcraftvalleyModElements instance) {
		super(instance, 129);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("cabbage_red_s_2"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cabbage_red_s_2");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(3, 0, 3, 13, 4, 13)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("cabbage_red_s_2");
		}
