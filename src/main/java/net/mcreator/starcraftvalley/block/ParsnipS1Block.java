...
public class ParsnipS1Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:parsnip_s_1")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:parsnip_s_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public ParsnipS1Block(StarcraftvalleyModElements instance) {
		super(instance, 85);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("parsnip_s_1"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(4, 0, 4, 12, 2, 12)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("parsnip_s_1");
		}
