...
public class CabbageRedS1Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:cabbage_red_s_1")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:cabbage_red_s_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public CabbageRedS1Block(StarcraftvalleyModElements instance) {
		super(instance, 125);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("cabbage_red_s_1"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cabbage_red_s_1");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(5, 0, 5, 11, 2, 11)
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(CabbageRedSeedsItem.block);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("cabbage_red_s_1");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Red Cabbage");
		}
