...
public class ParsnipS3Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:parsnip_s_3")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:parsnip_s_3")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public ParsnipS3Block(StarcraftvalleyModElements instance) {
		super(instance, 90);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("parsnip_s_3"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(5, 0, 5, 11, 5, 11)
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(ParsnipSeedsItem.block);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("parsnip_s_3");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Parsnip");
		}
