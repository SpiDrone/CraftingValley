...
public class GrapesS3Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:grapes_s_3")
	public static final Block block = null;
	@ObjectHolder("starcraftvalley:grapes_s_3")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public GrapesS3Block(StarcraftvalleyModElements instance) {
		super(instance, 29);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("grapes_s_3"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("grapes_s_3");
		}
