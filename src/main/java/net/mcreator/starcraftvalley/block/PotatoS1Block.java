...
public class PotatoS1Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:potato_s_1")
	public static final Block block = null;

	public PotatoS1Block(StarcraftvalleyModElements instance) {
		super(instance, 15);
	}
