...
public class PotatoS1Block extends SproutModElements.ModElement {
	@ObjectHolder("sprout:potato_s_1")
	public static final Block block = null;
	@ObjectHolder("sprout:potato_s_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public PotatoS1Block(SproutModElements instance) {
		super(instance, 15);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("potato_s_1"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(4, 0, 4, 12, 5, 12)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("potato_s_1");
		}
