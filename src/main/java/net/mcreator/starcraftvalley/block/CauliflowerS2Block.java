...
public class CauliflowerS2Block extends SproutModElements.ModElement {
	@ObjectHolder("sprout:cauliflower_s_2")
	public static final Block block = null;

	public CauliflowerS2Block(SproutModElements instance) {
		super(instance, 19);
	}
