...
public class CauliflowerS2Block extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:cauliflower_s_2")
	public static final Block block = null;

	public CauliflowerS2Block(StarcraftvalleyModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cauliflower_s_2");
		}
