...
public class Fertilizerspeed1Item extends SproutModElements.ModElement {
	@ObjectHolder("sprout:fertilizerspeed_1")
	public static final Item block = null;

	public Fertilizerspeed1Item(SproutModElements instance) {
		super(instance, 162);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fertilizerspeed_1");
		}
