...
public class PickaxeCopperItem extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:pickaxe_copper")
	public static final Item block = null;

	public PickaxeCopperItem(StarcraftvalleyModElements instance) {
		super(instance, 121);
	}
