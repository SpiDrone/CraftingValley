...
public class Wateringcan1Item extends SproutModElements.ModElement {
	@ObjectHolder("sprout:wateringcan_1")
	public static final Item block = null;

	public Wateringcan1Item(SproutModElements instance) {
		super(instance, 152);
	}
