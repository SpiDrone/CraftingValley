...
public class CabbageRedSeedsItem extends SproutModElements.ModElement {
	@ObjectHolder("sprout:cabbage_red_seeds")
	public static final Item block = null;

	public CabbageRedSeedsItem(SproutModElements instance) {
		super(instance, 130);
	}
