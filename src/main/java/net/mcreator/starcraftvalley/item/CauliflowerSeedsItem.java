...
public class CauliflowerSeedsItem extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:cauliflower_seeds")
	public static final Item block = null;

	public CauliflowerSeedsItem(StarcraftvalleyModElements instance) {
		super(instance, 50);
	}
