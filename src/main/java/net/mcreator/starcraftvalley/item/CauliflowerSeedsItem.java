...
public class CauliflowerSeedsItem extends SproutModElements.ModElement {
	@ObjectHolder("sprout:cauliflower_seeds")
	public static final Item block = null;

	public CauliflowerSeedsItem(SproutModElements instance) {
		super(instance, 50);
	}
