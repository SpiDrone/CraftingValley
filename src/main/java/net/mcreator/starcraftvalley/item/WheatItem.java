...
public class WheatItem extends StarcraftvalleyModElements.ModElement {
	@ObjectHolder("starcraftvalley:wheat")
	public static final Item block = null;

	public WheatItem(StarcraftvalleyModElements instance) {
		super(instance, 137);
	}
